...
| 016 | Line Mapper | controlled comparison/null | Build-first was frozen before EFM exploration; both arms were frozen before common evaluation. Common judge rejected 5/5 false mappers. Both candidates passed 20,590 initial and 161,669 post-green checks with zero failures/rework. EFM rejected `splitlines` prebuild but build-first independently chose the same correct scanner. Null delivered-correctness result. |
...
- `PROTOCOL_REVIEW_AFTER_015.md` retains v0.3 unchanged after three clean runs and redirects the next phase toward stronger research designs.
